...
export default function OrdersPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto bg-card rounded-xl shadow p-8 mt-10">
      <h2 className="text-2xl font-bold mb-6 text-gray-900 dark:text-foreground">Siparişlerim</h2>
      {orders.length === 0 && <div className="text-gray-500 dark:text-gray-400">Henüz siparişiniz yok.</div>}
