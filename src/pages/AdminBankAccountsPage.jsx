...
export default function AdminBankAccountsPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto bg-white rounded-xl shadow p-8 mt-10">
      <h2 className="text-2xl font-bold mb-6 text-gray-900">Banka Hesapları / IBAN Yönetimi</h2>
      <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-3 mb-6">
        ...
        <div className="flex gap-2">
          ...
          {editingId && <button type="button" onClick={() => { setEditingId(null); setForm({ bank_name: '', iban: '', account_holder: '', is_active: 1 }); }} className="bg-gray-200 hover:bg-gray-300 text-gray-700 font-bold px-4 py-2 rounded">İptal</button>}
        </div>
      </form>
